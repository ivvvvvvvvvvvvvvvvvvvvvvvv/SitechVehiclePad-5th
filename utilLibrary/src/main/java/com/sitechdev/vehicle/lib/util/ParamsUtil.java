...
public class ParamsUtil implements MMKVHandler {
    ...
    public static void init(Context context) {
        ...
        SitechDevLog.i(LOGTAG, "mmkv root: " + rootDir);
    ...
    public static String getStringData(String key) {
        ...
        return kvInstance.decodeString(key);
    }
    ...
    public static boolean getBooleanData(String key) {
        ...
        return kvInstance.decodeBool(key);
    }
    ...
    public static int getIntData(String key) {
        ...
        return kvInstance.decodeInt(key);
    }
    ...
    public void mmkvLog(MMKVLogLevel level, String file, int line, String func, String message) {
        ...
        switch (level) {
            case LevelDebug:
                SitechDevLog.d(LOGTAG, log);
                break;
            case LevelInfo:
                SitechDevLog.i(LOGTAG, log);
                break;
            case LevelWarning:
                SitechDevLog.w(LOGTAG, log);
                break;
            case LevelError:
                SitechDevLog.e(LOGTAG, log);
                break;
            case LevelNone:
            default:
                break;
